      ...
      fetch("https://api.generlate.com/v1/upload-generated-objects/", {
        ...
        .then((response) => {
          if (!response.ok) {
            ...
            if (library.includes(inputText.toLocaleLowerCase())) {
              setModel("https://api.generlate.com/media/v1/generated_objects/" + inputText.toLowerCase() + ".glb");
        ...
        .then((data) => {
          if (data.generated_object_file_path ==  `"${inputText}" not found in library.`) {
            ...
            setModel("https://api.generlate.com/media/v1/generated_objects/" + data.generated_object_file_path);
